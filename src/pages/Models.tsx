...
export default function Models() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
      <div>
        <h1 className="font-display text-3xl font-bold gold-text">Models & Follower</h1>
        <p className="text-muted-foreground mt-1">Verwalte deine Models und deren Followerzahlen.</p>
      </div>

      {/* Add New */}
      <div className="bg-surface-2 border border-border rounded-xl p-6 animate-fade-in-delay">
      ...
      {/* Table */}
      <div className="bg-surface-2 border border-border rounded-xl overflow-hidden animate-fade-in-delay-2">

...
const ALLOWED_CATEGORIES = [
  ...
  { emoji: "🔵", name: "ONBOARDING TAG 6" },
  { emoji: "🔵", name: "ONBOARDING TAG 7" },
  { emoji: "🔵", name: "ONBOARDING TAG 8" },
  { emoji: "🔵", name: "ONBOARDING TAG 9" },
  { emoji: "🔵", name: "ONBOARDING TAG 10" },
  { emoji: "🔵", name: "ONBOARDING TAG 11" },

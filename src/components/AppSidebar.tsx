import { LayoutDashboard, Upload, Users, Settings, MessageSquareText, LogOut, Video, Trophy, StickyNote, Flame } from "lucide-react";
...
const items = [
  ...
  { title: "Tinder Mode", url: "/tinder", icon: Flame },

import { LayoutDashboard, Upload, Users, Settings, MessageSquareText, LogOut, Video, Trophy, StickyNote, Flame, AlertOctagon, CalendarX } from "lucide-react";
...
const items = [
  ...
  { title: "Abwesenheit", url: "/absence", icon: CalendarX },
